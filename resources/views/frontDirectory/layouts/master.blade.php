...
<head>
    <meta charset="utf-8">
    <title>BSOS - Bangladesh School of Oncoplastic Surgery</title>
...
{{--                    <a class="text-decoration-none text-body pe-3" href=""><i class="bi bi-telephone me-2"></i>+880 1711 161199</a>--}}
{{--                    <span class="text-body">|</span>--}}
                    <a class="text-decoration-none text-body px-3" href=""><i class="bi bi-envelope me-2"></i>info@bsosbd.com</a>
                </div>
            </div>
            <div class="col-md-6 text-center text-lg-end">
                <div class="d-inline-flex align-items-center">
                    <a class="text-body px-2" target="_blank"  href="https://www.facebook.com/profile.php?id=100063763461416">
...
{{--                <h6 class="text-primary text-uppercase mt-4 mb-3">Follow Us</h6>--}}
                <div class="d-flex">
                    <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-2" target="_blank" href="https://www.facebook.com/profile.php?id=100063763461416"><i class="fab fa-facebook-f"></i></a>
                </div>
            </div>
        </div>
    </div>
